...
contract PalletStorageAccessor {
	...
	function getStorage(
		...
		KeyType keyType,
		bytes calldata firstKey,
		bytes calldata secondKey
		...
		return
			palletStorageReaderAddress.call(
				abi.encodePacked(
	...
	function getStorageWithOffsetAndLen(
		string calldata pallet,
		string calldata member,
		KeyType keyType,
		bytes calldata firstKey,
