...
fn raw_access() {
    ext().execute_with(|| {
        ...
        let raw_key = vec![67, 72, 185, 244, 78, 99, 49, 57, 216, 168, 24, 127, 78, 234, 212, 96, 213, 134, 173, 83, 23, 191, 182, 238, 194, 232, 224, 37, 134, 115, 248, 8, 199, 181, 78, 40, 234, 211, 141, 15, 124, 148, 20, 131, 114, 161, 6, 42];
        ...
        assert_eq!(Bytes::decode(&mut &out.output[1..]).unwrap(), Bytes::with_len(100));
