...
#[derive(Clone, Debug, Encode, Decode, Eq, Ord, PartialEq, PartialOrd, scale_info::TypeInfo)]
...
#[derive(Clone, Debug, Eq, Ord, PartialEq, PartialOrd, scale_info::TypeInfo)]
...
pub mod test_storage {
	...
	decl_storage! {
		trait Store for Pallet<T: Config> as TestStorage {
...
construct_runtime! {
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		TestStorage: test_storage::{Pallet, Call, Storage},
	}
}
